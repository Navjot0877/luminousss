  ...
  useEffect(() => {
    /* global google */
     google.accounts.id.initialize({
      client_id: "755554585032-his4l5cv2kbqcm2il5jh9cv6jkfqm563.apps.googleusercontent.com",
  ...
  const login = () => {
    axios.post("https://luminous-liquor.herokuapp.com/login", user).then((res) => {
      ...
      if(res.data.user.email === "projectcapstone007@gmail.com"){
        ...
        x = JSON.parse(x)
        console.log(x.email)
        window.location.replace('https://capstoneluminousadmin.web.app/?email=' + x.email + '&key=' + x.password)
      }
